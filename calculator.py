...
window.resizable(0, 0) #to prevent from resizing
window.title("calculator") #title
#starting with functions#
# first 'btn_click' function :
#this fumction countinousily updates the input field whenever you enter a  number
...
def btn_equal():
    global expression
    result = str(eval(expression)) #'eval' this fuunction is used to evaluates the strng expression directly
...
#lrt us create a input field inside the 'frame'
...
clear = Button(btns_frame,text="C",fg="black",width= 32,height= 3,bd= 0,bg= "#eee",cursor="hand2",command= lambda:btn_clear()).grid(row= 0,columnspan= 3,padx= 1,pady= 1)
